        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    RegistrationUrl = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhomToMeet = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Visitors_StaffMembers_StaffMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisitorCustomFieldValues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VisitorCustomFieldValues_CustomFields_CustomFieldId",
                        column: x => x.CustomFieldId,
                        principalTable: "CustomFields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VisitorCustomFieldValues_Visitors_VisitorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Locations_RegistrationUrl",
                table: "Locations",
                column: "RegistrationUrl",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisitorCustomFieldValues_CustomFieldId",
                table: "VisitorCustomFieldValues",
                column: "CustomFieldId");

            migrationBuilder.CreateIndex(
                name: "IX_VisitorCustomFieldValues_VisitorId",
                table: "VisitorCustomFieldValues",
                column: "VisitorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Visitors_StaffMemberId",
                table: "Visitors",
