...
const SettingsPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'general' | 'fields' | 'custom'>('general');
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-blue-100 opacity-80">Configure visitor registration form and options</p>
              </div>
            </div>
            <button
        ...
        <div className="p-8">
          {activeTab === 'general' && (
            <div className="space-y-8">
              ...
              {/* Photo Settings */}
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Photo Requirements</h3>
                <div className="bg-gray-50 rounded-lg p-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <Camera className="w-5 h-5 text-indigo-600 mr-3" />
                      <div>
                        <p className="font-medium text-gray-900">Photo Mandatory</p>
          ...
          {activeTab === 'fields' && (
            <div className="space-y-6">
              <h3 className="text-lg font-semibold text-gray-900">Form Field Visibility</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {Object.entries(settings.enabledFields).map(([field, enabled]) => (
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {field === 'email' && 'Visitor email address'}
                            {field === 'companyName' && 'Visitor company information'}
                            {field === 'idProof' && 'ID proof type and number'}
                            {field === 'photo' && 'Visitor photo capture'}
                          </p>
                        </div>
                      </div>
                      <button
